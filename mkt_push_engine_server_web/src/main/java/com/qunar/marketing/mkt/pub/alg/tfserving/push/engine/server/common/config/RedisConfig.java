...
public class RedisConfig {
    ...
    public Sedis3 getFeatureStorge(@Value("${redis.featureStorage.namespace}") String namespace,
                                    @Value("${redis.featureStorage.ciphor}") String ciphor,
        ...
        log.info("namespace: {}, ciphor: {}, timeout {}, zkA: {}", namespace,ciphor,timeout,zkAddr);
        return new Sedis3(namespace, ciphor, timeout, poolCoreSize, poolMaxSize, zkAddr);
    }

    @Bean(name = "featureStorge1")
    public Sedis3 getFeatureStorge1(@Value("${redis.featureStorage1.namespace}") String namespace,
                                    @Value("${redis.featureStorage1.ciphor}") String ciphor,
    ...
    public Sedis3 getFeatureStorge2(@Value("${redis.featureStorage2.namespace}") String namespace,
                                    @Value("${redis.featureStorage2.ciphor}") String ciphor,
